                ...
                <div class="row">                                              
                    <div class="col-md-6">
                        <div class="md-form form-sm">
                            ...
                            <label for="txtTituloAbout" class="active">Titulo About</label>  
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="md-form form-sm">
                            ...
                            <label for="txtDescipcionAbout" class="active">Descripcion about</label>
                        </div>
                    </div>                             
                </div>
            </div> 
                ...
                <div class="row">                                              
                    <div class="col-md-6">
                        <div class="md-form form-sm">
                            ...
                            <label for="txtTituloHorarios" class="active">Titulo Horarios</label>  
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="md-form form-sm">
                            ...
                            <label for="txtDescipcionHorarios" class="active">Descripcion Horarios</label>
                        </div>
                    </div>                             
                </div>
            </div> 
