...
<div class="primary-color narrower text-center">
    <div class="text-center"><h2 class="block-center white-text"> Mantenimiento de Usuarios </h2></div>
</div>      
        ...
        <div class="row">
            <div class="col-lg-12" style="margin-bottom: -20px;margin-top: -20px;">
                ...
                <div class="btn-group btn-group-sm inline" style="vertical-align: -35px;">
                    <a class="btn btn-primary" href="<?php echo e(URL::to('usuarios/create')); ?>" type="button" title="Nuevo apadrinado" id="MainToolbar_DXI0_"><span class="image fa fa-plus"></span></a>                    
...
$.confirm({
    ...
    function cargarDatatable(){
                ...
                tblUsuario = $('#tblUsuario').DataTable({
                        ...
                        //"serverSide": true,                        
                        dom: 'rtp',
                        "ajax": "<?php echo e(route('datatable.listaUsuario')); ?>",
                        //dom: 'frtip',
                        destroy: true,
