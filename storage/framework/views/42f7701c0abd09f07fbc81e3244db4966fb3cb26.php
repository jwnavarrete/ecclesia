    ...
    <div class="table-responsive">
    	<table id="tblGaleria" class="table table-bordered table-sm" data-wow-delay=".4s">
            ...
            <?php $__currentLoopData = Galeria::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $galeria): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>   
                <tr>
                	<td>
                		<img width="80" height="60" src="<?php echo e($galeria->ruta); ?><?php echo e($galeria->archivo); ?>">
                	</td>                    
                    <td>
                    	<div class="mb-2 mr-sm-2 col-sm-5 wrap-input-container">
	                    	<button class="custom-file-upload btn btn-primary btn-sm">
		    				...
		    				<input class="file-upload" onchange="cargarimagen(this)" codigo="<?php echo e($galeria->id); ?>" class="fileGaleria" name="file_name" type="file">
		    			</div>
                    </td>                     
                    <td>
		                <button onclick="eliminarImagen(<?php echo e($galeria->id); ?>)" class="btn btn-danger btn-sm delete" data-type="DELETE"">
