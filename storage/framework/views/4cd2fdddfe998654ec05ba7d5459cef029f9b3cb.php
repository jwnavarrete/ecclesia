                        ...
                        <div class="row">                        
                            ...
                            <div class="col-xl-9 col-md-8 mb-r">
                                ...
                                <div class="view gradient-card-header primary-color narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                                    <a href="" class="white-text mx-3"><?php if($cursos->id): ?> Editar Curso <?php echo e($cursos->titulo); ?> <?php else: ?> Nuevo Curso <?php endif; ?> </a>
                                    <div>
                                        <?php if($cursos->id): ?>
                                        <a href="<?php echo e(URL::to('cursos/create')); ?>" class="btn btn-outline-white btn-rounded btn-sm px-2 waves-effect waves-light"><i class="fa fa-plus mt-0"></i></a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(URL::to('cursos')); ?>" type="button" class="btn btn-outline-white btn-rounded btn-sm px-2 waves-effect waves-light"><i class="fa fa-undo mt-0"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <?php echo Form::open(['url' => url('cursos'), 'class' => '', 'data-parsley-validate','enctype' => 'multipart/form-data' ] ); ?>


                                            <div class="row">
                                                <input type="hidden" id="id" name="id" value="<?php echo e($cursos->id); ?>" >
                                                <input type="hidden" id="modo" name="modo" value="<?php echo e($cursos->id != '' ? "M" : 'C'); ?>" >
                                                ...
                                                <div class="col-md-3">
                                                    <div class="md-form form-sm">
                                                        <?php echo Form::select('maestro', $lista->getMaestros(), $cursos->maestro  , [
                                                             ...
                                                             <div class="md-form form-sm">
                                                                <div class="file-field">
                                                                    <div class="btn btn-primary btn-sm float-left">
                                                                        ...
                                                                        <?php echo Form::file('image', array('class' => 'image','multiple')); ?>
                                                ...
                                                <div class="col-md-12 text-center">
                                                    <div class="col-md-3 pull-right">
                                                            <?php echo Form::submit(($cursos->id!="" ? "Modificar" : "Crear" ),["class" =>"btn btn-sm btn primary-color btn-block register-btn"]
                                                            ); ?>
