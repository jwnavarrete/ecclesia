                ...
                <tr>                                    
                    ...
                    <td>                                    
                        <div class="btn-group btn-group-sm inline">
                            <button onclick="editAbout(<?php echo e($value); ?>)" class="btn btn-primary waves-effect waves-light btn_Editar" type="button" title="Editar">
                                <span class="image fa fa-pencil"></span>
                            </button>                    
                            <button onclick="removeAbout(<?php echo e($value->id); ?>);" class="btn btn-gplus waves-effect waves-light btn_Eliminar" type="button" title="Eliminar">
