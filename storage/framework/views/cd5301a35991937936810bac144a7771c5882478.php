                            ...
                            <div class="tab-content vertical">                                                            
                                <form action="frmChild" id="frmChild">
                                    ...
                                    <div class="tab-pane fade in show active" id="general" role="tabpanel">
                                        <?php echo $__env->make('pages.compassion.Children.include.general', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>                
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="actividad" role="tabpanel">                                        
                                        <?php echo $__env->make('pages.compassion.Children.include.actividades', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="salud" role="tabpanel">                                        
                                        <?php echo $__env->make('pages.compassion.Children.include.salud', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="estudios" role="tabpanel">                                        
                                        <?php echo $__env->make('pages.compassion.Children.include.estudios', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="guardianes" role="tabpanel">                                        
                                        <?php echo $__env->make('pages.compassion.Children.include.guardianes', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>                                                          
                                </form>
                            </div>
