<div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-lg-12">     
            <?php echo Form::select('actividades', $lista->getOptionsByData("ACT") , null , [                
                'required',
                'multiple',
                'id'=>"actividades",  
        ...
        <div class="col-lg-12">     
            <?php echo Form::select('obligaciones', $lista->getOptionsByData("OBLI") , null , [                
                'required',
                'multiple',
                'id'=>"obligaciones",  
                'searchable' => 'Buscar aqui...',
        ...
        <div class="col-lg-12">     
            <?php echo Form::select('pasatiempos', $lista->getOptionsByData("PASA") , null , [                
                'required',
                'multiple',
                'id'=>"pasatiempos",  
                'searchable' => 'Buscar aqui...',
