                ...
                <ul class="navbar-nav mr-auto">                    
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item waves-effect waves-light" href="#contactenos">Contactenos</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#horarios" data-offset="100">Nuestros Horarios</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item waves-effect waves-light" href="#instituto">Instituto biblico</a>
                            <a class="dropdown-item waves-effect waves-light" href="#casaamanecer">Casa Amanecer</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#donaciones" data-offset="100">Donaciones</a>
                    </li>                
                </ul>
                <ul class="nav navbar-nav nav-flex-icons ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#contactenos"><i class="fa fa-envelope"></i> <span class="clearfix d-none d-sm-inline-block">Contactenos</span></a>
                    </li>                    
                    <li class="nav-item">                        
                        ...
                        <div class="col-md-12">
                            <div class="text-center text-white">
                                <div class="wow fadeInDown" data-wow-delay=".2s">
                                    <h2 class="font-bold display-2 mb-0"><?php echo e(config('app.name', 'ICI')); ?></h2>
