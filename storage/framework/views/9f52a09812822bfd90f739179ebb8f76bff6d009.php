    ...
    <div class="modal-dialog cascading-modal modal-avatar modal-lg" role="document2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center mb-1">
                ...
                <?php echo Form::open(['action' => 'ParametroController@crudMinisterio', 'class' => '', 'data-parsley-validate','enctype' => 'multipart/form-data' ] ); ?>
                        ...
                        <div class="col">
                            <div class="md-form mt-0">
                                <input class="form-control form-control-sm validate ml-0" placeholder="Titulo" 
                                    ...
                                    type="text" 
                                    data-parsley-id="4">
                                <label data-error="wrong" data-success="right" for="ministerioTitulo" class="ml-0">Titulo</label>
                            </div>
                        </div>
                        <div class="col">
                            <div class="md-form mt-0">
                    ...
                    <div class="md-form ml-0 mr-0">
                        <textarea class="form-control form-control-sm validate ml-0 md-textarea" placeholder="Nombre"  
                            ...
                            ></textarea>
                            <label data-success="right" for="ministerioDescripcion" class="ml-0">Descripcion</label>
                    </div>
                    ...
                    <div class="text-right mt-4">
                        ...
                        <a type="button" class="btn btn-outline-warning waves-effect" data-dismiss="modal">Cerar</a>
                    </div>
