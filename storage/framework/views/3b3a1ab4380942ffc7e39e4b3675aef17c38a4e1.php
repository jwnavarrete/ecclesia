...
<div class="tab-pane fade in show" id="equipo" role="tabpanel">    
    <div class="table-responsive">            
        <table id="tblEquipo" class="table table-striped table-bordered table-sm">                
            ...
            -->                                                                                             
            <?php $__currentLoopData = Equipo::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>                                    
                        <td><?php echo e($value->nombre); ?></td>
                        <td><?php echo e($value->cargo); ?></td>                                                                            
                        <td style="text-align:justify"><?php echo e($value->descripcion); ?></td>
                        <!--JOFRE ALENXANDER MORALES PLACENCIO
                            * NOTONES DE ADMINISTRACION
                        -->                                                                                    
                        <td style="text-align: center;">
                            <div class="btn-group btn-group-sm inline">
                                <button onclick="editEquipo(<?php echo e($value); ?>);" class="btn btn-primary waves-effect waves-light btn_Editar" type="button" title="Editar"><span class="image fa fa-pencil"></span></button>                    
                                <button onclick="removeEquipo(<?php echo e($value->id); ?>);" class="btn btn-gplus waves-effect waves-light btn_Eliminar" type="button" title="Eliminar"><span class="image fa fa-trash"></span></button>                                                                    
                            </div>                            
                        </td>
                    </tr>
