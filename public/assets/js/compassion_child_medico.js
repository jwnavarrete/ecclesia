        ...
        oTable = $('#tblCompassion').DataTable({
            ...
            columns: [                                                                                                                        
                ...
                {data: "codigo","render": function(data, type, row, meta){                                                                          
                    ...
                    <button class="btn btn-primary waves-effect waves-light" onclick="cargaChild('${data}');" type="button" title="Consultar"><span class="image fa fa-search"></span></button>                    
                    <button class="btn btn-primary waves-effect waves-light" onclick="nuevaConsulta('${data}');" type="button" title="Nueva consulta médica"><span class="image fa fa-stethoscope"></span></button>                    
                    <button class="btn btn-warning waves-effect waves-light" onclick="cargarConsultas('${data}');"  type="button" title="Historial médico"><span class="image fa fa-folder-open-o "></span></button>                                                                    
                </div>`;
...
function nuevaConsulta(codigo){    
    limpiarModal();
    $('#childModalConsulta').modal('show');
    ...
    $.ajax({
        ...
        success: function( response ){             
            if (continuaSession(response)) {                            
                $("#codigoNino").val(response.data.codigo).change();                        
                $("#slSexoNino").val(response.data.sexo).change();                    
                ...
                d = new Date();                
                $("#clickerImageNino").attr('src', "/img/compassion/" + response.data.foto +"?"+d.getTime() );                    
                $("#imgTitleNino").attr('src', "/img/compassion/" + response.data.foto +"?"+d.getTime());                    

                $("#lblnombreNino").html(response.data.primerNombre + ' ' + response.data.segundoNombre + ' '+response.data.apellidoPaterno + ' '+response.data.apellidoMaterno);
