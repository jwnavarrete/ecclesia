...
<body class="band-lp">
        ...
        <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark  scrolling-navbar scrolling-navbar double-nav">
            ...
            <div class="navbar-collapse collapse" id="navbarSupportedContent" style="">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto">
                    ...
                    <li class="nav-item">                        
                        <a class="nav-link" href="{{ route('home') }}" ><i class="fa fa-user"></i> {{ Auth::check() === true ? Auth::user()->first_name : "Iniciar Session" }} </a>
                    </li>
                    @if(Auth::check())						
                        ...
                        <div class="col-md-12">
                            <div class="text-center text-white">
                                <div class="wow fadeInDown" data-wow-delay=".2s">
                                    <h2 class="font-bold display-2 mb-0">{{ config('app.name', 'ICIR') }}</h2>
    ...
    <main>
        ...
        <div class="col-md-12">
            ...
            -->
            <div class="container">
               @include('landing.institutobiblico')
            </div>
