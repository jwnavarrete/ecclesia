                            ...
                            <div class="tab-content vertical">                                                            
                                <form action="frmConsulta" id="frmConsulta">
                                    <div class="tab-pane fade in show active" id="general" role="tabpanel">
                                        @include('pages.compassion.ControlMedico.include.general')                
                                    </div>
                                    
                                    <div class="tab-pane fade" id="actividad" role="tabpanel">                                        
                                        @include('pages.compassion.ControlMedico.include.actividades')
                                    </div>

                                    <div class="tab-pane fade" id="salud" role="tabpanel">                                        
                                        @include('pages.compassion.ControlMedico.include.salud')
                                    </div>

                                    <div class="tab-pane fade" id="estudios" role="tabpanel">                                        
                                        @include('pages.compassion.ControlMedico.include.estudios')
                                    </div>

                                    <div class="tab-pane fade" id="guardianes" role="tabpanel">                                        
                                        @include('pages.compassion.ControlMedico.include.guardianes')
                                    </div>                                                          
                                </form>
                            </div>
