                        ...
                        <div class="col-xl-3 col-md-4 mb-r">
                            ...
                            <div class="col-xl-9 col-md-8 mb-r">
                                ...
                                <div class="view gradient-card-header primary-color narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                                    <a href="" class="white-text mx-3">@if($cursos->suscrito) Cancelar Inscripcion  @else Inscribirse  @endif  {{ $cursos->titulo }}</a>
                                    <div>                                     
                                        <a href="{{ URL::to('inscripciones') }}" type="button" class="btn btn-outline-white btn-rounded btn-sm px-2 waves-effect waves-light"><i class="fa fa-undo mt-0"></i></a>
                                    </div>
                                </div>
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        {!! Form::open(['route' => 'addInscripcion', 'class' => '', 'data-parsley-validate','enctype' => 'multipart/form-data' ] ) !!}
                                            <!--First row-->
                                            <div class="row">
                                                <input type="hidden" id="id" name="id" value="{{ $cursos->id }}" >
                                                <input type="hidden" id="modo" name="modo" value="{{{ $cursos->suscrito == 1 ? "REMOVE" : 'ADD' }}}" >
                                                ...
                                                <div class="col-md-12 text-center">
                                                    <div class="col-md-3 pull-right"> 
                                                        @if($cursos->suscrito==1)
                                                        {!! Form::submit("CANCELAR INSCRIPCION",["class" =>"btn btn-danger btn-sm"]
                                                            ) !!}
                                                        @else
                                                        {!! Form::submit("INSCRIBIRSE",["class" =>"btn btn-success btn-sm"]
                                                            ) !!}
                                                        @endif
