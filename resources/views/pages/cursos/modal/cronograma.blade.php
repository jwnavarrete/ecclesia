                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" >
                                    <div class="pull-right">
                                        <button type="button" onclick="limpiarCronograma();" style="" class="btn btn-sm btn-warning mt-1">Limpiar</button>
                                        <button type="button" onclick="saveCronogramaCurso();" style="" class="btn btn-sm btn-cyan mt-1">Grabar</button>
                                    </div>
                                </div>
